                        ...
                        <div className="mb-4 flex gap-4 justify-center md:justify-start">
                            ...
                            <a href="https://www.instagram.com/tronix365?utm_source=qr&igsh=MXBpODJkcWc3d3Vveg==" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#E1306C] transition-all duration-300 transform hover:scale-110">
                                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772 4.902 4.902 0 011.772-1.153c.636-.247 1.363-.416 2.427-.465 1.067-.047 1.407-.06 4.123-.06h.08zm3.52 1.185c-1.064-.049-1.791-.06-2.828-.06-3.468 0-3.823.012-4.949.064-1.126.052-1.894.228-2.604.504a3.702 3.702 0 00-1.343.874 3.702 3.702 0 00-.874 1.343c-.276.71-.452 1.478-.504 2.604-.052 1.126-.064 1.481-.064 4.949 0 3.468.012 3.823.064 4.949.052 1.126.228 1.894.504 2.604.246.636.574 1.166.874 1.343.636.246 1.166.574 1.343.874.71.276 1.478.452 2.604.504 1.126.052 1.481.064 4.949.064 3.468 0 3.823-.012 4.949-.064 1.126-.052 1.894-.228 2.604-.504.636-.246 1.166-.574 1.343-.874.246-.636.574-1.166.874-1.343.276-.71.452-1.478.504-2.604.052-1.126.064-1.481.064-4.949 0-3.468-.012-3.823-.064-4.949-.052-1.126-.228-1.894-.504-2.604a3.702 3.702 0 00-.874-1.343 3.702 3.702 0 00-1.343-.874c-.71-.276-1.478-.452-2.604-.504-1.126-.052-1.481-.064-4.949-.064z" clipRule="evenodd" />
                                </svg>
                            </a>
                            {/* WhatsApp */}
